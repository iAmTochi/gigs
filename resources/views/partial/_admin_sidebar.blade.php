            ...
            <ul data-submenu-title="Main Navigation">
                ...
                <li class="accordion">
                    ...
                    <ul id="manage-user" class="collapse">
                        <li><a href="#"><i class="lni lni-bookmark mr-2"></i>View All Users<span class="count-tag bg-warning">4</span></a></li>
                        <li><a href="#"><i class="lni lni-mastercard mr-2"></i>Add New User</a></li>
